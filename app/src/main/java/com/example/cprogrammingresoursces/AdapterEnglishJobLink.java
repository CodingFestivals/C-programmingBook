...
public class AdapterEnglishJobLink extends RecyclerView.Adapter<AdapterEnglishJobLink.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterEnglishJobLink(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterEnglishJobLink.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterEnglishJobLink.MyViewHolder myViewHolder, int i) {
