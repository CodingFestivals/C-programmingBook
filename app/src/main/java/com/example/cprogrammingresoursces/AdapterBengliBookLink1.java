...
public class AdapterBengliBookLink1 extends RecyclerView.Adapter<AdapterBengliBookLink1.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterBengliBookLink1(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterBengliBookLink1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterBengliBookLink1.MyViewHolder myViewHolder, int i) {
