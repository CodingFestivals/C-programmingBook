...
public class AdapterBengliJobLink extends RecyclerView.Adapter<AdapterBengliJobLink.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterBengliJobLink(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterBengliJobLink.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterBengliJobLink.MyViewHolder myViewHolder, int i) {
