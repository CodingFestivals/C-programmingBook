...
public class AdapterEnglishLearningLink extends RecyclerView.Adapter<AdapterEnglishLearningLink.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterEnglishLearningLink(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterEnglishLearningLink.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterEnglishLearningLink.MyViewHolder myViewHolder, int i) {
