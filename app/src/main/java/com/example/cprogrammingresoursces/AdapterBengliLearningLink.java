...
public class AdapterBengliLearningLink extends RecyclerView.Adapter<AdapterBengliLearningLink.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterBengliLearningLink(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterBengliLearningLink.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterBengliLearningLink.MyViewHolder myViewHolder, int i) {
