...
public class AdapterEnglishBookLink1 extends RecyclerView.Adapter<AdapterEnglishBookLink1.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterEnglishBookLink1(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterEnglishBookLink1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterEnglishBookLink1.MyViewHolder myViewHolder, int i) {
