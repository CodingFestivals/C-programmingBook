...
public class AdapterHindiBookLink1 extends RecyclerView.Adapter<AdapterHindiBookLink1.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterHindiBookLink1(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterHindiBookLink1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterHindiBookLink1.MyViewHolder myViewHolder, int i) {
