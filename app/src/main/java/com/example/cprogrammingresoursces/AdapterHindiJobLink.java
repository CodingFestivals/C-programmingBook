...
public class AdapterHindiJobLink extends RecyclerView.Adapter<AdapterHindiJobLink.MyViewHolder>{
    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterHindiJobLink(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterHindiJobLink.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterHindiJobLink.MyViewHolder myViewHolder, int i) {
